...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <aside
        className={`fixed inset-y-0 right-0 z-50 flex w-72 max-w-[85vw] flex-col border-l border-white/60 bg-white/70 shadow-2xl shadow-black/10 backdrop-blur-xl transition-transform duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] lg:static lg:z-auto lg:w-64 lg:translate-x-0 lg:border-l-0 lg:bg-white/50 lg:shadow-none lg:backdrop-blur-[30px] ${
      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center justify-between px-5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-2xs text-gray-400">مدیریت اقساط</span>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mx-4 h-px shrink-0 bg-linear-to-l from-transparent via-gray-200 to-transparent" />
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `group relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 ${
                        isActive
                          ? "bg-linear-to-l from-indigo-500 to-violet-600 text-white shadow-md shadow-indigo-500/25"
                        ...
                        <span
                          className={`flex h-8 w-8 items-center justify-center rounded-lg transition-all duration-200 ${
                            isActive
                              ...
                              : "text-gray-400 group-hover:bg-white/60 group-hover:text-gray-700"
                          }`}
                        >
        ...
        {/* Footer */}
        <div className="shrink-0 border-t border-white/60 px-3 py-3">
          <button
